...
import { AuthType, type Role } from '@prisma/client';
...
export class AuthService {
  ...
  private async createAccessToken(userId: number, role: Role) {
  ...
  async registerByPhone(
    ...
    try {
      ...
      if (
        ...
        throw new ConflictException('Такой номер уже используется');
      }
      throw error;
    }
  }
